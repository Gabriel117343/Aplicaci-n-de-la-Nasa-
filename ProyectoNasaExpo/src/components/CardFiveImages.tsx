...
export const CardFiveImages: React.FC<PropsCardFiveImages> = ({ data }) => {
...
export const AnimatedCardFiveImages: React.FC<PropsAnimatedCard> = ({ data, index }) => {
